	...
	return []okapi.RouteDefinition{
		{
			...
			Summary:     "Read the platform branding",
		},
		{
			...
			Summary:     "Set the platform branding: name, logos, accent policy and sign-in links",
...

		{
			...
			Group:       g,
			Middlewares: admin,
			Handler:     r.h.adminStorageClass.List,
		...
		},
		{
			...
			Group:       g,
			Middlewares: admin,
			Handler:     okapi.H(r.h.adminStorageClass.Create),
			Summary:     "Register a storage class (a directory volumes are created in)",
			Request:     &handlers.CreateStorageClassRequest{},
		},
		{
			Method:      http.MethodGet,
			Path:        "/storage-classes/{id}",
			Group:       g,
			Middlewares: admin,
			Handler:     r.h.adminStorageClass.Get,
			Summary:     "Get a storage class",
		},
		{
			Method:      http.MethodPut,
			Path:        "/storage-classes/{id}",
			Group:       g,
			Middlewares: admin,
			Handler:     okapi.H(r.h.adminStorageClass.Update),
			Summary:     "Update a storage class (its key and path are immutable)",
			Request:     &handlers.UpdateStorageClassRequest{},
		},
		{
			Method:      http.MethodDelete,
			Path:        "/storage-classes/{id}",
			Group:       g,
			Middlewares: admin,
			Handler:     r.h.adminStorageClass.Delete,
			Summary:     "Delete a storage class no volume uses",
		},
		{
			Method:      http.MethodGet,
			Path:        "/plans",
