  ...
  <div>
    <div class="page-header">
      ...
      <button
        ...
        @click="openCreate"
      >
        <span class="mdi mdi-plus"></span>Add provider</button>
    </div>
    ...
    <div class="card">
      ...
      <div v-else-if="providers.length === 0" class="empty-state">
        ...
        <p class="text-muted">Add Google or a generic OIDC provider to enable single sign-on.</p>
          ...
          <div class="modal-body">
            ...
            <template v-if="form.type === 'oidc'">
              ...
              <div class="form-group">
                ...
                <span class="form-hint">Userinfo claim mapped to the handle. Blank = standard "preferred_username"; if the provider sends neither, the handle is derived from the email address.</span>
              </div>
            </template>
            ...
            <div class="form-group toggles" style="margin-bottom: 0">
              ...
              <label class="check-row" :class="{ 'check-disabled': !hiddenCap.has.value && !form.hidden }">
                ...
                />Hidden<span v-if="!hiddenCap.has.value && !form.hidden" class="mdi mdi-lock-outline cap-lock" :title="hiddenTitle"></span>
              </label>
              <label class="check-row">
                <input v-model="form.auto_register" type="checkbox" />Auto-register users</label>
            </div>
          </div>
